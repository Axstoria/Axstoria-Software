...
namespace CharacterSheet.Presenter.ViewModel.Widgets
{
    public class PointGaugeViewModel : WidgetViewModel
    {
        ...
        public PointGaugeViewModel(PointGaugeWidget widget,
            ...
            UpdatePointGaugeWidgetUseCase up) : base(widget, containerId, bindStatToWidgetUseCase, unbindStatUseCase, appearance, background, imageService, updateLayout, updateTitle, getStat)
        {
            _gauge = widget;
